<template>
  ...
  <div class="content">
    <img src="@/assets/needle-ab.png" :class="isPlay ? img_needle_active : img_needle">
    <img src="@/assets/cd.png" alt="" class="img_cd">
    <img :src="musicList.al.picUrl" alt="" class="img_song" :class="isPlay ? img_song_active : img_song_paused">
  </div>
  <div class="footer">
    <div class="footerTop">
      <svg class="icon" aria-hidden="true">
